...
ALTER TABLE "public"."function_debug_logs" OWNER TO "postgres";


CREATE SEQUENCE IF NOT EXISTS "public"."function_debug_logs_id_seq"
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
ALTER TABLE "public"."function_debug_logs_id_seq" OWNER TO "postgres";
...
CREATE TABLE IF NOT EXISTS "public"."notes" (
    ...
    CONSTRAINT "check_only_one_subject" CHECK (((("subject_member_id" IS NULL) AND ("subject_invited_id" IS NOT NULL)) OR (("subject_member_id" IS NOT NULL) AND ("subject_invited_id" IS NULL)) OR (("subject_member_id" IS NULL) AND ("subject_invited_id" IS NULL))))
);
...
ALTER TABLE ONLY "public"."function_debug_logs" ALTER COLUMN "id" SET DEFAULT "nextval"('"public"."function_debug_logs_id_seq"'::"regclass");
...
ALTER TABLE ONLY "public"."function_debug_logs"
    ADD CONSTRAINT "function_debug_logs_pkey" PRIMARY KEY ("id");
...
ALTER TABLE ONLY "public"."notes"
    ADD CONSTRAINT "notes_creator_id_fkey" FOREIGN KEY ("creator_id") REFERENCES "public"."company_members"("id");



ALTER TABLE ONLY "public"."notes"
    ADD CONSTRAINT "notes_subject_invited_id_fkey" FOREIGN KEY ("subject_invited_id") REFERENCES "public"."invited_users"("id");



ALTER TABLE ONLY "public"."notes"
    ADD CONSTRAINT "notes_subject_member_id_fkey" FOREIGN KEY ("subject_member_id") REFERENCES "public"."company_members"("id");
...
GRANT ALL ON TABLE "public"."function_debug_logs" TO "anon";
GRANT ALL ON TABLE "public"."function_debug_logs" TO "authenticated";
GRANT ALL ON TABLE "public"."function_debug_logs" TO "service_role";



GRANT ALL ON SEQUENCE "public"."function_debug_logs_id_seq" TO "anon";
GRANT ALL ON SEQUENCE "public"."function_debug_logs_id_seq" TO "authenticated";
GRANT ALL ON SEQUENCE "public"."function_debug_logs_id_seq" TO "service_role";
