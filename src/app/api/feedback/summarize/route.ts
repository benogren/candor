...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `
      You are an expert career coach analyzing 360-degree feedback for a professional.
    ...
    //     { 
    //       role: "system", 
    //       content: "You are a helpful career coach providing feedback analysis. Your summaries are balanced, constructive, and actionable."
    //     },
    //     { 
    //       role: "user", 
    //       content: prompt
