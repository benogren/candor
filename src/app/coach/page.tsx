    ...
    <div className="flex flex-col min-h-screen">
      ...
      <noscript>
        <img 
          ...
          width="1" 
          style={{ display: 'none' }} 
          src="https://www.facebook.com/tr?id=9746830468718722&ev=PageView&noscript=1"
          alt="" 
        />
      </noscript>
      ...
      <main className="flex-1 flex bg-slate-50">
        <div className="container mx-auto px-4">
          <div className="flex flex-col md:flex-row relative">
            <div className="w-full md:w-1/2 py-8 md:py-24 z-10">
              ...
              {/* Mobile-only image that appears below the form */}
            ...
            <div className="md:w-1/2 md:absolute md:right-0 md:bottom-0 md:h-full overflow-hidden hidden md:block">
      ...
      <div className='bg-cerulean py-12 md:py-16'>
        <div className="container mx-auto px-4 flex flex-col items-center">
          <h2 className={`text-3xl md:text-4xl font-light text-white max-w-4xl text-center ${radley.className}`}>
            How it Works
          </h2>

          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 md:gap-8">
            <div className="mt-6 md:mt-8 rounded-lg shadow-lg bg-gradient-to-bl from-cerulean-600 to-cerulean-700 p-6 md:p-8">
              <h3 className={`text-xl md:text-2xl font-light text-white ${radley.className}`}>
                <Smartphone className='mb-2 text-cerulean-200' />
                Text-Based Simplicity
              </h3>
              <p className="text-cerulean-200 text-sm md:text-base font-light mt-2">
                No apps to download. Just text our number anytime, 24/7, and get an immediate response.
              </p>
            </div>
            
            <div className="mt-2 md:mt-8 rounded-lg shadow-lg bg-gradient-to-bl from-cerulean-600 to-cerulean-700 p-6 md:p-8">
              <h3 className={`text-xl md:text-2xl font-light text-white ${radley.className}`}>
          ...
          <p className={`text-white max-w-2xl text-base md:text-lg font-light mt-10 md:mt-12 text-center`}>
      ...
      <div className='bg-slate-50 py-10 md:py-16' id="testimonials">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className={`text-3xl md:text-4xl font-light text-cerulean max-w-4xl ${radley.className}`}>
            What Our Users Are Saying
          </h2>
          <p className={`text-slate-500 text-sm md:text-base font-light max-w-xl mt-3 md:mt-4 mb-8 md:mb-12`}>
            Hear from professionals who have transformed their careers with Candor Coach.
          </p>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8">
            {/* Testimonial 1 */}
            <div className="bg-white rounded-lg shadow-md p-5 md:p-8 text-left relative">
              <p className="text-slate-600 italic text-sm md:text-base mb-4 md:mb-6">
      ...
      {/* Pricing Section */}
      <div className='bg-white py-10 md:py-16' id="pricing">
        <div className="container mx-auto px-4 flex flex-col items-center text-center">
          <h2 className={`text-3xl md:text-4xl font-light text-cerulean max-w-4xl ${radley.className}`}>
            Pricing
          </h2>
            ...
            <div className="mx-auto px-4 flex flex-col items-center">
              <div className="w-full max-w-md">
                <div className='bg-white rounded-lg shadow-md p-6 md:p-8 border border-slate-200'>
                  <div className="flex items-center justify-center mb-6 md:mb-8 mt-2">
                    <div className="bg-slate-50 p-6 md:p-10 rounded-lg border border-slate-200">
                      <div className="flex items-baseline justify-center">
                        <span className={`text-3xl md:text-4xl font-light text-slate-900`}>$5</span>
                      </div>
                      <div className="text-center mt-2 text-slate-500 text-sm md:text-base">per week</div>
                    </div>
                  </div>

                  <div className="px-2 md:px-6 pb-4 md:pb-6 rounded-lg">
                    <h4 className={`text-lg md:text-xl font-light text-cerulean mb-3 md:mb-4 ${radley.className}`}>All Features Included</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-2 md:gap-3 text-left">
                      <div className="flex items-start">
                        <svg className="h-5 w-5 text-cerulean flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <p className="ml-2 md:ml-3 text-slate-500 text-xs md:text-sm">24/7 text-based career coaching</p>
                      </div>
                      <div className="flex items-start">
                        <svg className="h-5 w-5 text-cerulean flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <p className="ml-2 md:ml-3 text-slate-500 text-xs md:text-sm">Personalized coach personality</p>
                      </div>
                      <div className="flex items-start">
                        <svg className="h-5 w-5 text-cerulean flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <p className="ml-2 md:ml-3 text-slate-500 text-xs md:text-sm">Goal-setting frameworks</p>
                      </div>
                      <div className="flex items-start">
                        <svg className="h-5 w-5 text-cerulean flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <p className="ml-2 md:ml-3 text-slate-500 text-xs md:text-sm">Weekly check-ins and planning</p>
                      </div>
                      <div className="flex items-start">
                        <svg className="h-5 w-5 text-cerulean flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <p className="ml-2 md:ml-3 text-slate-500 text-xs md:text-sm">Specialized career exercises</p>
                      </div>
                      <div className="flex items-start">
                        <svg className="h-5 w-5 text-cerulean flex-shrink-0 mt-0.5" fill="currentColor" viewBox="0 0 20 20">
                          <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-9.293a1 1 0 00-1.414-1.414L9 10.586 7.707 9.293a1 1 0 00-1.414 1.414l2 2a1 1 0 001.414 0l4-4z" clipRule="evenodd" />
                        </svg>
                        <p className="ml-2 md:ml-3 text-slate-500 text-xs md:text-sm">Unlimited conversations</p>
                      </div>
                    </div>
                  </div>
                </div>
      ...
      <footer className="bg-white text-slate-500 py-8">
        <div className="container mx-auto px-4 border-t border-slate-300 mt-6 pt-6">
          <p className={`text-cerulean text-center mb-4 text-lg ${radley.className}`}>
            candor<i>coach</i> is a product of <Link href="/" className="text-slate-400 hover:text-slate-500 transition duration-200">candor</Link>
          </p>
          <div className="flex flex-col items-center">
            <div className="flex flex-col items-center mb-4">
              <p className="text-gray-400 text-sm mb-2">&copy; {new Date().getFullYear()} Candor 360, Inc. All rights reserved.</p>
              <div className="flex space-x-4">
                <Link href="/terms" className="text-slate-400 hover:text-slate-500 transition duration-200 text-sm">Terms of Use</Link>
                <Link href="/privacy" className="text-slate-400 hover:text-slate-500 transition duration-200 text-sm">Privacy Policy</Link>
              </div>
            </div>
            <div className="flex space-x-4">
