        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow">
            ...
            <div className="prose text-slate-700">
              <p className="text-lg font-medium">Last Updated: April 22, 2025</p>

              <p>
                The website located at www.candor.so (the &quot;Site&quot;) is a copyrighted work belonging to Candor 360, Inc. (&quot;Company&quot;, &quot;us&quot;, &quot;our&quot;, and &quot;we&quot;). Certain features of the Site may be subject to additional guidelines, terms, or rules, which will be posted on the Site in connection with such features. All such additional terms, guidelines, and rules are incorporated by reference into these Terms.
              </p>
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">1. Accounts</h2>
              
              <h3 className="text-lg text-slate-900 mt-4 mb-2">1.1 Account Creation</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">1.2 Account Responsibilities</h3>
              <p>
                You are responsible for maintaining the confidentiality of your Account login information and are fully responsible for all activities that occur under your Account. You agree to immediately notify Company of any unauthorized use, or suspected unauthorized use of your Account or any other breach of security. Company cannot and will not be liable for any loss or damage arising from your failure to comply with the above requirements.
              </p>

              <h2 className="text-xl text-slate-900 mt-8 mb-4">2. Access to the Site</h2>
              
              <h3 className="text-lg text-slate-900 mt-4 mb-2">2.1 License</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">2.2 Certain Restrictions</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">2.3 Modification</h3>
              <p>
                Company reserves the right, at any time, to modify, suspend, or discontinue the Site (in whole or in part) with or without notice to you. You agree that Company will not be liable to you or to any third party for any modification, suspension, or discontinuation of the Site or any part thereof.
              </p>
              
              <h3 className="text-lg text-slate-900 mt-4 mb-2">2.4 No Support or Maintenance</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">2.5 Ownership</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">2.6 Feedback</h3>
              <p>
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">3. User Content</h2>
              
              <h3 className="text-lg text-slate-900 mt-4 mb-2">3.1 User Content</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">3.2 License</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">3.3 Acceptable Use Policy</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">3.4 Enforcement</h3>
              <p>
                We reserve the right (but have no obligation) to review, refuse and/or remove any User Content in our sole discretion, and to investigate and/or take appropriate action against you in our sole discretion if you violate the Acceptable Use Policy or any other provision of these Terms or otherwise create liability for us or any other person. Such action may include removing or modifying your User Content, terminating your Account in accordance with Section 8, and/or reporting you to law enforcement authorities.
              </p>

              <h2 className="text-xl text-slate-900 mt-8 mb-4">4. Indemnification</h2>
              <p>
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">5. Third-Party Links & Ads; Other Users</h2>
              
              <h3 className="text-lg text-slate-900 mt-4 mb-2">5.1 Third-Party Links & Ads</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">5.2 Other Users</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">5.3 Release</h3>
              <p>
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">6. Disclaimers</h2>
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">7. Limitation on Liability</h2>
              <p className="uppercase">
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">8. Term and Termination</h2>
              <p>
              ...
              <h2 className="text-xl text-slate-900 mt-8 mb-4">9. Copyright Policy</h2>
              <p>
              ...
              <p>
                The designated Copyright Agent for Company is: Ben Ogren<br />
                {/* Address: 16287 Beckwith Run, Broomfield, Colorado 80023<br />
                Telephone: 317-679-8098<br /> */}
                Email: ben@candor.so
              </p>

              <h2 className="text-xl text-slate-900 mt-8 mb-4">10. General</h2>
              
              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.1 Changes</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.2 Dispute Resolution</h3>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.a Applicability of Arbitration Agreement</h4>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.b Informal Dispute Resolution</h4>
              <p>
              ...
              <p>
                The party initiating a Dispute must give notice to the other party in writing of its intent to initiate an Informal Dispute Resolution Conference (&quot;Notice&quot;), which shall occur within 45 days after the other party receives such Notice, unless an extension is mutually agreed upon by the parties. Notice to Company that you intend to initiate an Informal Dispute Resolution Conference should be sent by email to: ben@candor.so, or by regular mail to 16287 Beckwith Run, Broomfield, Colorado 80023. The Notice must include: (1) your name, telephone number, mailing address, e‐mail address associated with your account (if you have one); (2) the name, telephone number, mailing address and e‐mail address of your counsel, if any; and (3) a description of your Dispute.
              </p>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.c Arbitration Rules and Forum</h4>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.d Authority of Arbitrator</h4>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.e Waiver of Jury Trial</h4>
              <p className="uppercase">
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.f Waiver of Class or Other Non-Individualized Relief</h4>
              <p className="uppercase">
              ...
              <p>
                Subject to this Arbitration Agreement, the arbitrator may award declaratory or injunctive relief only in favor of the individual party seeking relief and only to the extent necessary to provide relief warranted by the party&apos;s individual claim. Nothing in this paragraph is intended to, nor shall it, affect the terms and conditions under the Subsection 10.2(h) entitled &quot;Batch Arbitration.&quot; Notwithstanding anything to the contrary in this Arbitration Agreement, if a court decides by means of a final decision, not subject to any further appeal or recourse, that the limitations of this subsection, &quot;Waiver of Class or Other Non-Individualized Relief,&quot; are invalid or unenforceable as to a particular claim or request for relief (such as a request for public injunctive relief), you and Company agree that that particular claim or request for relief (and only that particular claim or request for relief) shall be severed from the arbitration and may be litigated in the state or federal courts located in the State of Colorado. All other Disputes shall be arbitrated or litigated in small claims court. This subsection does not prevent you or Company from participating in a class-wide settlement of claims.
              </p>
              
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.g Attorneys&apos; Fees and Costs</h4>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.h Batch Arbitration</h4>
              <p>
              ...
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.i 30-Day Right to Opt Out</h4>
              <p>
                You have the right to opt out of the provisions of this Arbitration Agreement by sending a timely written notice of your decision to opt out to the following address: 16287 Beckwith Run, Broomfield, Colorado 80023, or email to ben@candor.so, within 30 days after first becoming subject to this Arbitration Agreement. Your notice must include your name and address and a clear statement that you want to opt out of this Arbitration Agreement. If you opt out of this Arbitration Agreement, all other parts of these Terms will continue to apply to you. Opting out of this Arbitration Agreement has no effect on any other arbitration agreements that you may currently have with us, or may enter into in the future with us.
              </p>
              
              <h4 className="text-base text-slate-900 mt-4 mb-2 underline">10.2.j Invalidity, Expiration</h4>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.4 Disclosures</h3>
              <p>
                Company is located at the address in Section 10.8. If you are a California resident, you may report complaints to the Complaint Assistance Unit of the Division of Consumer Product of the California Department of Consumer Affairs by contacting them in writing at 400 R Street, Sacramento, CA 95814, or by telephone at (800) 952-5210.
              </p>

              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.5 Electronic Communications</h3>
              <p>
                The communications between you and Company use electronic means, whether you use the Site or send us emails, or whether Company posts notices on the Site or communicates with you via email. For contractual purposes, you (a) consent to receive communications from Company in an electronic form; and (b) agree that all terms and conditions, agreements, notices, disclosures, and other communications that Company provides to you electronically satisfy any legal requirement that such communications would satisfy if it were be in a hardcopy writing. The foregoing does not affect your non-waivable rights.
              </p>

              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.6 Entire Terms</h3>
              <p>
              ...
              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.7 Copyright/Trademark Information</h3>
              <p>
                Copyright © 2025 Candor 360, Inc. All rights reserved. All trademarks, logos and service marks (&quot;Marks&quot;) displayed on the Site are our property or the property of other third parties. You are not permitted to use these Marks without our prior written consent or the consent of such third party which may own the Marks.
              </p>

              <h3 className="text-lg text-slate-900 mt-4 mb-2">10.8 Contact Information</h3>
              <p>
                {/* Ben Ogren<br />
                Address: 16287 Beckwith Run, Broomfield, Colorado 80023<br />
                Telephone: 317-679-8098<br /> */}
                Email: support@candor.so
              </p>
            </div>
          </div>
        </div>
